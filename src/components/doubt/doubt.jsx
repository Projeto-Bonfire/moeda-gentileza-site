            ...
            <ul>
                <li><div className={`dropdown ${isActive ? 'active' : ''}`}>
                    <div className='dropdown-btn' onClick={(e) =>
                        ...
                        Dúvida 1
                        <span className='fas fa-caret-down'><img src={nextIcon} alt="next" className='next' /></span>
                    </div>
                    {isActive && (
                ...
                <li><div className={`dropdown ${isActive4 ? 'active' : ''}`}>
                    <div className='dropdown-btn' onClick={(e) =>
                        ...
                        Dúvida 4                        <span className='fas fa-caret-down'><img src={nextIcon} alt="next" className='next' /></span>
                    </div>
                    {isActive4 && (
                        <div className='dropdown-content'>
                            <div className='dropdown-item'>
